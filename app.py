...
# Base de datos 2026 actualizada con imagen oficial (M35-M60 y F35-F60)
MINIMAS_DB = {
    "Hombre": {
    ...
    "Mujer": {
        ...
        "200m": {"Absoluto": 24.25, "Sub23": 25.00, "Sub20": 25.25, "Sub18": 25.25, "F35": 26.42, "F40": 27.95, "F45": 28.56, "F50": 28.60, "F55": 30.19, "F60": 32.06},
        "400m": {"F35": 61.15, "F40": 62.69, "F45": 64.29, "F50": 65.95, "F55": 68.18, "F60": 74.29}
    }
}
